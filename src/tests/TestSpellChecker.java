...
import bktree.DemerauLevenshteinCalculator;
import bktree.IDistanceCalculator;
import bktree.LevenshteinCalculator;
import bktree.KeyboardLayout;
import bktree.KeyboardLayoutList;
import bktree.KeyboardLayoutNeutro;
import bktree.DictionaryReader;
import bktree.KeyboardLayoutReader;
import bktree.BurkhardKellerTree;
import bktree.BurkhardKellerTreeSearchResult;
...
public class TestSpellChecker
{
	...
	{
		KeyboardLayout layout = new KeyboardLayoutNeutro();//Factory?
		IDistanceCalculator calculator = new LevenshteinCalculator(layout);//Factory?
